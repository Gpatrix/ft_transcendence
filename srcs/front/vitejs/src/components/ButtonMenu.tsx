...
export default function ButtonMenu({className, setFriends, friendId} : ButtonMenuProps) {
    ...
    return (
        <div className='absolute top-0 right-0'>
            <button onClick={() => handleOpenMenu()} className={clsx('absolute z-60 rounded-full bg-blue2 w-[40px] h-[40px] flex items-center justify-around blue-shadow-btn cursor-pointer', className)}>
                <div className='rounded-full bg-blue1 w-[8px] h-[8px]'></div>
                <div className='rounded-full bg-blue1 w-[8px] h-[8px]'></div>
                <div className='rounded-full bg-blue1 w-[8px] h-[8px]'></div>
            </button>

...
export default function AuthLayout() {
    return (
        <div className='h-[100vh] flex flex-col items-center justify-center '>
            <h1 className='text-shadow-lg/40  text-shadow-purple absolute center font-extrabold font-title text-yellow text-[5vw] top-15 md:text-3xl mb-[5vh]'>ft_transcendance</h1>
